...
## 1. 查找不到附近的设备
PasteFlow Dev 使用 DNS-SD（DNS Service Discovery）进行服务发现，就像局域网打印服务发现是类似的。如果你的局域网内服务发现没有正常工作，这可能有多个原因
...
如果命令行工具能够发现服务，但是 PasteFlow Dev 无法发现，那么可能是 PasteFlow Dev 的问题，你可以提交 issue 给我们
